...
local M = {
  ...
  opts = {
    ...
    highlights = {
      ["@_env"] = { link = "@conceal" },
      ["@_frac_name"] = { link = "@conceal" },
      ["@_func_name"] = { link = "@conceal" },
      ["@_line"] = { link = "@conceal" },
      ["@abs_name"] = { link = "@conceal" },
      ["@close_paren"] = { link = "@conceal" },
      ["@cmd"] = { link = "@conceal" },
      ["@comma"] = { link = "@conceal" },
      ["@conceal"] = { link = "Conceal" },
      ["@conceal_dollar"] = { link = "@conceal" },
      ["@content"] = { link = "@conceal" },
      ["@first_letter"] = { link = "@conceal" },
      ["@font_letter"] = { link = "@conceal" },
      ["@frac"] = { link = "@conceal" },
      ["@func"] = { link = "@conceal" },
      ["@func_name"] = { link = "@conceal" },
      ["@left_1"] = { link = "@conceal" },
      ["@left_2"] = { link = "@conceal" },
      ["@left_brace"] = { link = "@conceal" },
      ["@left_content"] = { link = "@conceal" },
      ["@left_paren"] = { link = "@conceal" },
      ["@left_paren_cmd"] = { link = "@conceal" },
      ["@open_paren"] = { link = "@conceal" },
      ["@punctuation"] = { link = "@conceal" },
      ["@right_1"] = { link = "@conceal" },
      ["@right_2"] = { link = "@conceal" },
      ["@right_brace"] = { link = "@conceal" },
      ["@right_content"] = { link = "@conceal" },
      ["@right_paren"] = { link = "@conceal" },
      ["@right_paren_cmd"] = { link = "@conceal" },
      ["@second_letter"] = { link = "@conceal" },
      ["@sub_letter"] = { link = "@conceal" },
      ["@sub_object"] = { link = "@conceal" },
      ["@sub_symbol"] = { link = "@conceal" },
      ["@sup_letter"] = { link = "@conceal" },
      ["@sup_object"] = { link = "@conceal" },
      ["@sup_symbol"] = { link = "@conceal" },
      ["@symbol"] = { link = "@conceal" },
      ...
      ["@typ_inline_ampersand"] = { link = "@conceal" },
      ["@typ_inline_asterisk"] = { link = "@conceal" },
      ["@typ_inline_dollar"] = { link = "@conceal" },
      ["@typ_inline_quote"] = { link = "@conceal" },
